        ...
        <div id="ed-weaknodes-wrap-${id}" style="margin-top:4px;display:${existing?.weakNodes ? 'block' : 'none'};">
          ...
          <div style="display:flex;gap:6px;align-items:center;margin-top:2px;">
            ...
            <select id="ed-weaknodes-pattern-${id}" style="flex:1;padding:2px;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.15);color:#eee;font:10px monospace;border-radius:3px;">
              ...
              <option value="vortex">Vortex (beat)</option>
              <option value="starPulse">Star Pulse (beat)</option>
              <option value="twirl">Twirl</option>
              <option value="rosette">Rosette</option>
              <option value="iris">Iris (beat)</option>
          ...
          <div style="display:flex;gap:6px;align-items:center;margin-top:2px;">
            ...
            <input id="ed-weaknodes-beatdiv-${id}" type="range" min="0.5" max="4" step="0.5" value="${existing?.weakNodeBeatDiv ?? 1}" style="flex:1;">
          </div>
          <div style="display:flex;gap:6px;align-items:center;margin-top:2px;">
            <span style="color:#7FE6FF;font:10px monospace;">Amp: <span id="ed-weaknodes-amp-val-${id}">${existing?.weakNodeAmp ?? 0.3}</span></span>
            <input id="ed-weaknodes-amp-${id}" type="range" min="0" max="2" step="0.05" value="${existing?.weakNodeAmp ?? 0.3}" style="flex:1;">
          </div>
          <div style="display:flex;gap:6px;align-items:center;margin-top:2px;">
